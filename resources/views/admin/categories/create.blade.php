                                ...
                                <div class="tab-pane fade show active" id="english" role="tabpanel">
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" name="name_en" class="form-control @error('name_en') is-invalid @enderror" value="{{ old('name_en') }}" placeholder="Technology, Sports, Politics">
                                            @error('name_en')
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <textarea name="description_en" class="form-control" rows="1">{{ old('description_en') }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="tab-pane fade" id="bangla" role="tabpanel">
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" name="name_bn" class="form-control @error('name_bn') is-invalid @enderror" value="{{ old('name_bn') }}" placeholder="প্রযুক্তি, খেলাধুলা, রাজনীতি">
                                            @error('name_bn')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                            <small class="text-muted">At least one language is required (English OR Bangla)</small>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <textarea name="description_bn" class="form-control" rows="1">{{ old('description_bn') }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="tab-pane fade" id="seo" role="tabpanel">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" name="meta_title_bn" class="form-control" value="{{ old('meta_title_bn') }}">
                                        </div>
                                        <div class="col-md-6 mb-3">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <textarea name="meta_description_bn" class="form-control" rows="2">{{ old('meta_description_bn') }}</textarea>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label class="form-label">Meta Keywords (English)</label>
                                            <input type="text" name="meta_keywords_en" class="form-control" value="{{ old('meta_keywords_en') }}" placeholder="keyword1, keyword2, keyword3">
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label class="form-label">Meta Keywords (বাংলা)</label>
                                            <input type="text" name="meta_keywords_bn" class="form-control" value="{{ old('meta_keywords_bn') }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="tab-pane fade" id="settings" role="tabpanel">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" name="icon" class="form-control" value="{{ old('icon') }}" placeholder="fas fa-newspaper">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="form-check form-check-primary form-check-inline">
                                                <input class="form-check-input" type="checkbox" name="show_in_menu" id="show_in_menu" value="1" {{ old('show_in_menu', true) ? 'checked' : '' }}>
