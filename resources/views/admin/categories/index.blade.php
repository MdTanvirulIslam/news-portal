                ...
                <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
                    <div class="widget-content widget-content-area br-8">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            ...
                            <a href="{{ route('admin.categories.create') }}" class="btn btn-primary _effect--ripple waves-effect waves-light">
...
$(document).ready(function() {
    table = $('#categories-table').DataTable({
        ...
        columns: [
            ...
            { 
                ...
                render: function(data, type, row) {
                    ...
                    let icon = row.level > 0 ? '<i class="fas fa-level-up-alt fa-rotate-90 text-muted me-1"></i>' : '';
                    return indent + icon + (row.name_en || row.name_bn || 'N/A');
                }
            },
            { 
                data: 'parent',
                ...
                render: function(data, type, row) {
                    return `
                        <div class="action-btns d-flex gap-2 justify-content-center">
                            <a href="/admin/categories/${row.id}/edit" class="btn btn-sm btn-icon btn-warning" data-bs-toggle="tooltip" title="Edit">
                            ...
                            <button onclick="deleteCategory(${row.id})" class="btn btn-sm btn-icon btn-danger" data-bs-toggle="tooltip" title="Delete">
        ...
        pageLength: 10,
        order: [[6, 'asc']], // Sort by order column
...
function bulkDelete() {
    Swal.fire({
        title: 'Are you sure?',
        text: `Delete ${selectedIds.length} selected category(ies)?`,
        icon: 'warning',
            ...
            $.ajax({
                ...
                error: function(xhr) {
                    Swal.fire({
                        icon: 'error',
                        title: 'Error!',
                        text: xhr.responseJSON?.message || 'Failed to delete categories',
                        confirmButtonText: 'OK',
                        customClass: {
                            confirmButton: 'btn btn-danger'
                        },
