...
<head>
    ...
    <title>{{ config('app.name', 'News Portal') }} - Register as Reporter</title>
...
<div class="register-container">
    <div class="register-card">
        <div class="register-header">
            <h2>Register as Reporter</h2>
            <p>Join our team of professional journalists</p>
        </div>
        ...
        <div class="register-body">
            ...
            <form method="POST" action="{{ route('admin.register.reporter.store') }}">
                @csrf
                ...
                <div class="alert alert-info">
                    <small>
                        ...
                        <strong>Note:</strong> Reporter accounts require admin approval.
                ...
                <div class="text-center">
                    <p class="mb-0">
                        ...
                        <a href="{{ route('admin.register.contributor') }}" class="text-primary text-decoration-none">Register as Contributor</a>
                    </p>
                </div>
            </form>
        </div>
